# Manually forked from https://github.com/metaskills/mocha-phantomjs
# - Proof of concept for test coverage using istanbul
...
class Reporter
  ...
  finish: ->
    cov = @page.evaluate -> JSON.stringify __coverage__
    fs = require 'fs'
    fs.write 'coverage/coverage.json', cov
